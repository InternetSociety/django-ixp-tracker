            ...
            try:
                models.IXP.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "manrs_participant": ixp_data["id"] in data_lookup.get_manrs_participants(processing_date),
                        "anchor_host": ixp_data["id"] in data_lookup.get_atlas_anchor_hosts(processing_date),
