            ...
            try:
                ...
                models.ASN.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "roa_v4_valid": rpki_summary["v4"]["valid"],
                        "roa_v4_invalid": rpki_summary["v4"]["invalid"],
                        "roa_v4_unknown": rpki_summary["v4"]["unknown"],
                        "roa_v6_valid": rpki_summary["v6"]["valid"],
                        "roa_v6_invalid": rpki_summary["v6"]["invalid"],
                        "roa_v6_unknown": rpki_summary["v6"]["unknown"],
