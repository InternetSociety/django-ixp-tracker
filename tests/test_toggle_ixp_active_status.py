...
from tests.fixtures import create_ixp_fixture, create_member_fixture_deprecated
...
def test_active_ixp_with_3_members_remains_active():
    ...
    create_member_fixture_deprecated(ixp, 12345)
    create_member_fixture_deprecated(ixp, 23456)
    create_member_fixture_deprecated(ixp, 34567)
...
def test_active_ixp_gone_from_three_to_two_active_members_is_marked_inactive():
    ...
    create_member_fixture_deprecated(ixp, 12345)
    create_member_fixture_deprecated(ixp, 23456)
    create_member_fixture_deprecated(ixp, 34567, date_left=end_date)
